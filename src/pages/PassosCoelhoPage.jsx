  ...
  return (
    <>
      ...
      <main className="person-page">
        ...
        <section className="person-figures" id="figuras" aria-label="Figuras da peça Pedro Passos Coelho">
          <figure className="person-figure"><img src={imgFrente} alt="Figura frente da peça Pedro Passos Coelho" /><figcaption>Fig1 : frente da peça</figcaption></figure>
          <figure className="person-figure"><img src={imgEsquerda} alt="Figura lado esquerdo da peça Pedro Passos Coelho" /><figcaption>Fig2 : lado esquerdo da peça</figcaption></figure>
          {/* <figure className="person-figure"><img src={placeholderFigureImage} alt="Figura traseira da peça Pedro Passos Coelho" /><figcaption>Fig3 : traseira da peça</figcaption></figure> */}
          <figure className="person-figure"><img src={imgDireita} alt="Figura lado direito da peça Pedro Passos Coelho" /><figcaption>Fig4 : lado direito da peça</figcaption></figure>
        </section>
