      ...
      <main className="person-page">
        ...
        <section className="person-figures" id="figuras" aria-label="Figuras da peca Javier Milei">
          <figure className="person-figure">
            <img src={placeholderFigureImage} alt="Figura frente da peca Javier Milei" />
            <figcaption>Fig1 : frente da peca</figcaption>
          </figure>

          <figure className="person-figure">
            <img src={placeholderFigureImage} alt="Figura lado esquerdo da peca Javier Milei" />
          ...
          <figure className="person-figure">
            <img src={placeholderFigureImage} alt="Figura lado direito da peca Javier Milei" />
